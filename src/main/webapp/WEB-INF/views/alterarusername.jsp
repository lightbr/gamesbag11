    ...
    <div class="container-fluid">
      ...
      <div id="esqueleto" class="row">
        ...
        <div id="conteudo" class="col-xs-9 col-md-9">
          ...
          <!-- modal alterar User Name -->
          <div class="col-xs-4 col-md-6 col-md-offset-3" > 

            <form class="form-signin">
            <h2 class="form-signin-heading text-center">Alterar o User Name</h2>
            
            <p></p>
            <label for="inputNewUsername">Digite o novo User Name</label>
            <input type="text" id="inputNewUsername" class="form-control" placeholder="User Name" required autofocus>
            <p></p>
            <button class="btn btn-lg btn-success btn-block" type="submit">Salvar</button>
            </form>
          </div><!-- /modal alterar User name -->
